...
export default function CreateTherapistForm({ onSubmit, isSubmitting, errors }: CreateTherapistFormProps) {
    ...
    return <div>
        ...
        <form onSubmit={onSubmitForm} noValidate>
            ...
            <div className="mb-3">
                <label htmlFor="firstName" className="form-label">{t('pages.register.form.name_label')}</label>
                <input
                    type="text"
                    id="firstName"
                    name="firstName"
                ...
                />
                {errors.FirstName && <div className="invalid-feedback">{t('pages.register.validation.name_required')}</div>}
            </div>
