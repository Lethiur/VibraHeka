    ...
    return (
        <div className="landing-page">
            <section className="landing position-relative d-flex align-items-center justify-content-center overflow-hidden text-center py-4 py-md-5">
                <Container className="landing-inner text-center mx-3 mx-sm-4 mx-md-auto p-3 p-sm-4 rounded-4">
                    <Logo
                    ...
                    <div className="cta-wrapper mt-4 mt-md-5">
                        <PrimaryButton label="Quiero unirme a VibraHeka"  />
                    </div>
                </Container>
            </section>
                    ...
                    <section className="landing-intro">
                        ...
                        <Row className="landing-intro__pain justify-content-center text-center mb-5">
                            ...
                            <Col lg={8}>
                                ...
                                <p>El cuerpo empieza a hablar cuando llevas demasiado tiempo acumulando tensión, preocupaciones o emociones que no han tenido espacio para salir.

                                    Y suele hacerlo de formas muy concretas:</p>
